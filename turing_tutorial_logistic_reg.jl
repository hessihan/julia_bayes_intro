...
# if else --> condition ? true_value : false_value
...
# train and split (; enable to change default argument `at`)
...
# Rescale variables for efficient parameter searching.
for feature in numerics
    μ, σ = rescale!(trainset[!, feature], obsdim=1) # rescale!() overwrite the memory
...
# Calculate percentage of correctly predicted.
